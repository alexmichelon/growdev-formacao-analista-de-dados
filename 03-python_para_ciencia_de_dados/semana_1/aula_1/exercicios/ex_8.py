...
def compare_atempt_whit_position_board(right_atempts, line, column):
    try:
    ...
    return right_atempts

           

print('\nBem vindo ao Jogo Água e Navio 1.0:\n'
...
while(len(list_atempts) < max_atempts_permited) and (right_atempts < max_ships_permited):   
    ...
    right_atempts = compare_atempt_whit_position_board(right_atempts, line, column)    
